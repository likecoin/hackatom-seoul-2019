...
// Create the core parameters for genesis initialization for likechain
// note that the pubkey input is this machines pubkey
func LikeAppGenState(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
...
// LikeValidateGenesisState ensures that the genesis state obeys the expected invariants
// TODO: No validators are both bonded and jailed (#2088)
// TODO: Error if there is a duplicate validator (#1708)
// TODO: Ensure all state machine parameters are in genesis (#1704)
func LikeValidateGenesisState(genesisState GenesisState) error {
...
// LikeAppGenState but with JSON
func LikeAppGenStateJSON(cdc *codec.Codec, genDoc tmtypes.GenesisDoc, appGenTxs []json.RawMessage) (
	appState json.RawMessage, err error) {
	// create the final app state
	genesisState, err := LikeAppGenState(cdc, genDoc, appGenTxs)
	if err != nil {
		return nil, err
	}
