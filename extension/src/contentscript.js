...
if (DOM) {
  ...
  if (wallet && sourceURL) {
    DOM.innerHTML = `<div style="height:50px;width:50px;border-radius:50%"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 186 186" class="simple-svg" style="fill: currentcolor; stroke: transparent;">
...
<path d="m145.2 143.9c-0.4 0.8 0.1 1.4 0.5 1.9 2 2.5 11.6 12.3 13.9 14.2 1.1 0.9 2 0.8 2.8 0.1 1-0.9 2.1-2.6 3.5-5.4 1.5-2.9 2.2-4.7 2.4-6 0.1-1-0.3-1.9-1.7-2.3-2.8-0.8-16.4-3-19.6-3.2-0.5-0.1-1.4-0.2-1.8 0.7z"></path>
    ...
    DOM.addEventListener('click', onLike({ wallet, sourceURL }));
  }
}
